...
public class NavigationBoardingActivity extends AppCompatActivity {

    ViewPager slideViewPager;
    LinearLayout dotIndicator;
    Button backButton, nextButton, skipButton;
    TextView[] dots;
    ViewpagerOnboardingAdapter viewPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navigation_boarding);
        ...
        viewPagerAdapter = new ViewpagerOnboardingAdapter(this);
